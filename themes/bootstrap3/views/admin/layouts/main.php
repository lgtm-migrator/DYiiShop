    ...
    <body>
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">
                            <img alt="<?php echo Yii::app()->name; ?>" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/logo-admin.png" />
                        </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown <?php if($this->action->getController()->getId() == "products" || $this->action->getController()->getId() == "categories" || $this->action->getController()->getId() == "manufacturers" || $this->action->getController()->getId() == "attributes" || $this->action->getController()->getId() == "attributeGroups"): ?>active<?php endif; ?>">
                                <a class="dropdown-toggle" data-toggle="dropdown" role="button" href="#">Catalog <b class="caret"></b></a>
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li class="divider"></li>
                                    <li class="dropdown-header"><?php echo Yii::t('attributes', 'Attributes'); ?></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li class="dropdown-header"><?php echo Yii::t('customers', 'Customers'); ?></li>
                                    ...
                                    <li class="divider"></li>
                                    <li class="dropdown-header"><?php echo Yii::t('giftVouchers', 'Gift Vouchers'); ?></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li class="dropdown-header"><?php echo Yii::t('design', 'Design'); ?></li>
                                    ...
                                    <li class="divider"></li>
                                    <li class="dropdown-header"><?php echo Yii::t('users', 'Users'); ?></li>
                                    ...
                                    <li class="divider"></li>
                                    <li class="dropdown-header"><?php echo Yii::t('localization', 'Localization'); ?></li>
        ...
        <div class="container">
            ...
            <?php if (isset($this->breadcrumbs) && count($this->breadcrumbs)): ?>
                <ol class="breadcrumb">
                    <li><a href="<?php echo $this->createUrl('/admin'); ?>"><?php echo Yii::t('common', 'Home'); ?></a> </li>
