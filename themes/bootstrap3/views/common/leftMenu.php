        ...
        <ul class="nav">
            ...
            <li>
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a href="<?php echo $this->createUrl('/category/view', array('id'=>$childCategory->category_id)); ?>"> - <?php echo $childCategory->description->name; ?> (<?php echo $childCategory->getProductsCount(); ?>)</a></li>
                    <?php endforeach; ?>
                </ul>
                <?php endif; ?>
            </li>
